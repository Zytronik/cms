...
<head>
    ...
    <script defer src="js/vendor/apexcharts.min.js"></script>
        ...
        <div class="container-large">
            <div class="row">
                <div class="col-12">
                    <nav>
                        <ul>
                            <li><a class="headerlink" href="<?php echo get_directory_url(); ?>admin/"><i
                                        class="fas fa-file-alt"></i><span>Seiten</span></a></li>
                            <li><a class="headerlink" href="<?php echo get_directory_url(); ?>admin/blocks.php"><i
                                        class="fas fa-th-large"></i><span>Blöcke</span></a></li>
                            <li><a class="headerlink" href="<?php echo get_directory_url(); ?>admin/menus.php"><i
                                        class="fas fa-compass"></i><span>Menüs</span></a></li>
